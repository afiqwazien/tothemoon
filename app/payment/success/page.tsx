...
// Outer page component wraps content in Suspense (required by Next.js for useSearchParams)
    ...
    <div className="min-h-screen bg-[#FDFCFB]">
      ...
      <Suspense fallback={
        <div className="flex items-center justify-center min-h-[60vh]">
          <div className="w-8 h-8 border-4 border-[#312821] border-t-transparent rounded-full animate-spin" />
        </div>
      }>
